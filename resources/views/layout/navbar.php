  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php if(session_get('local') == 'en'): ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo url('lang?lang=ar'); ?>"><?php echo trans('main.arabic'); ?></a></li>
          <?php else: ?>
            <li class="nav-item"><a class="nav-link" href="<?php echo url('lang?lang=en'); ?>"><?php echo trans('main.english'); ?></a></li>
            <?php endif; ?>
